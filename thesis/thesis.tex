...
for instance inlining as described in \cite{SECR}.} Thus, any noticable speed
difference should not be due to zepto.
...
in zepto usually takes the lead. Even so, the difference is never bigger
than eighteen percent, more often than not even under ten percent.
...
in Figure \ref{fig:base64}\footnote{It is denoted as ``zepto-js \gls{ffi}''.}.
