...
code is presented in \ref{fig:mutobs}.
...
paramaters\footnote{This approach is shown in \ref{fig:idealffi}.}. While is arather elegant
...
of the \gls{ffi} is shown in \ref{fig:finalffi}.}. While this places the burden of coercion
...
and from the \gls{dom} is presented in \ref{fig:dom}. A production-ready
...
as output\footnote{An example language implementing JSON is presented in \ref{fig:json}.}.
